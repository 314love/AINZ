...
<html lang="en">
  ...
  <body>
		...
		<div class="container d-flex align-items-center">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item active"><a href="about2.jsp" class="nav-link">动物识别</a></li>
    ...
    <!-- END nav -->
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/bg_6.jpg');width: 100%;height: 852px">
...
<%--          	<p class="breadcrumbs"><span class="mr-2"><a href="index.jsp">Home <i class="fa fa-chevron-right"></i></a></span> <span>About us <i class="fa fa-chevron-right"></i></span></p>--%>
            <h1 class="mb-0 bread" style="font-size: 60px;">AI图像智能识别动物</h1>
			  <br>
			  <%-- start--%>
