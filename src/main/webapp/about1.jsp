...
<html lang="en">
  ...
  <body>
    ...
    <!-- END nav -->
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/bg_3.jpg');width: 100%;height: 852px">
...
<%--          	<p class="breadcrumbs"><span class="mr-2"><a href="index.jsp">Home <i class="fa fa-chevron-right"></i></a></span> <span>About us <i class="fa fa-chevron-right"></i></span></p>--%>
            <h1 class="mb-0 bread" style="font-size: 60px;">AI图像智能识别病虫害</h1>
			  <br>
<%--			  &lt;%&ndash;图片检测 start&ndash;%&gt;--%>
<%--			  <form action="${pageContext.request.contextPath}/DiseasesPests/Basic" method="post" enctype="multipart/form-data">--%>
...
<%--			  </form>--%>
			  <form action="${pageContext.request.contextPath}/animal/getanimal" method="post" enctype="multipart/form-data">
				  <input type="file" name="picFile" placeholder="上传图片" class="btn btn-primary" id="app1"/><br/><br/>
				  <input type="submit" value="图片检测" class="btn btn-primary" id="app">
			  </form><br>
			  <%--图片检测 end--%>
