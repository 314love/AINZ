				...
				<div class="col-md-3 ftco-animate">
					<div class="blog-entry">
						...
						<div class="text d-block text-center">
							<h3 class="heading">${plant.name}</h3>
...
<%-- 图表插入--%>
					...
					<div style="padding-left: 80px">
						<h3>百度百科图片链接</h3>
						<a href="${plant.baike_info.baike_url}" style="font-size: 20px">${plant.baike_info.baike_url}</a><br/>
						<h3>百度百科页面链接</h3>
						<a href="${plant.baike_info.image_url}" style="font-size: 20px">
							${plant.baike_info.image_url}
						</a>
					</div><br/>
				</div>
			</div>
